...
if __name__=="__main__":
    ...
    print("Testing local potential (chemical potential ): ", colored('Passed', "green") if ~np.any(M_f_diff) else colored('Failed ',"red"))
    ...
    print("Wrapper gives the same results as the step-by-step procedure: ", colored(~np.any(diff),"green"))